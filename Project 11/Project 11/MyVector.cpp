...

{
	...
	vCapacity = b.vCapacity;
	this->myArray = new int [vCapacity];

	// copy the data
	for (int i = 0; i < b.vCapacity; i++)
	{
		this->myArray[i] = b.myArray[i];
	}
...
MyVector::~MyVector(void)
{
	...
	// Overloaded << operator, wo we can output the string
	// Purpose: out put the string
	// Parameters: a stream and a vector object
	// returns: the stream object

	ostream& operator<< (ostream& output, const MyVector& vect)
	{
