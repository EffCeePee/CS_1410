...
void Hourly::readData (string)
{
}


void Hourly::writeData (string fileName, Hourly emp)
{
	ofstream outStream;
...
double Hourly::calPay ()
{
	double grossPay = 0; 
	double overtime = 40;
	double timeAndHalf = 1.5;
	double netPay = 0;
	double fedDeduction = grossPay * .2;
	double stateDeduction = grossPay * .075;
