...
// The short string function
// Purpose: shorten a string to be compared with another string
// Parameters: string passed by a function
// Returns: a new short string
// ===============================================
	...
	if (str1[0] == str2[0])
		   {
			   ...
			   // if the first letters match, test to see if the substring can be found
